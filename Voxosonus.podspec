#
#  Be sure to run `pod spec lint Voxosonus.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "HeercoGrond"
  # s.authors            = { "Heerco_Grond" => "heercogrond@live.nl" }
  # s.social_media_url   = "http://twitter.com/Heerco_Grond"
